        ...
        >
              ...
              {["facebook", "twitter", "instagram", "linkedin"].map(
                (social, index) => (
                  ...
                  >
                    ...
                    >
                      {/* Simple icon paths for different social networks */}
                      {index === 0 && (
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">
                  123 Construction Avenue, Industrial Area, City, State - 123456
                </span>
              </li>
          ...
          <motion.div variants={fadeInUpVariants}>
            ...
            <p className="text-gray-300 mb-4">
              Stay updated with our latest products, projects, and industry
              insights.
            </p>
            <form className="space-y-3">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-400"
                />
              </div>
              <motion.button
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.98 }}
                className="gradient-bg-1 w-full text-white py-3 rounded-lg shadow-lg hover:shadow-purple-500/25 transition-shadow"
              >
                Subscribe
              </motion.button>
            </form>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Tirupati Precast. All rights
              reserved.
            </p>
