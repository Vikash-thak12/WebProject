      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        >
          <motion.div variants={fadeInUpVariants} className="relative">
            ...
            <div
              className="absolute -right-10 -bottom-10 w-60 h-60 rounded-full bg-indigo-100 opacity-30 animate-pulse-slow"
          ...
          <div>
            ...
            >
              Our state-of-the-art machinery allows us to bring to you
              absolutely the best quality of products as well as great services,
              all at reasonable prices. We collaborate across multiple
              disciplines to deliver first-class solutions for customers while
              ensuring we carry on growing and adapting to the market&apos;s
              evolving needs.
            </motion.p>
